...
Bot 不直接读写存档，只通过 Web 服务的 HTTP API 工作。插件开发说明见 [docs/PLUGIN_DEVELOPMENT_CN.md](docs/PLUGIN_DEVELOPMENT_CN.md)，示例插件在 `plugins/examples/`，可用 `python scripts\package_plugin.py plugins\examples\starter-content --overwrite` 打包测试。
